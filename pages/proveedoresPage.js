...
class ProveedoresPage extends BasePage {
  constructor(page) {
    ...
    this.submenuProveedores = page.locator('#tab-22:has-text("Proveedores")');
    ...
    this.tabla = page.locator('#proveedor tbody');
  ...
  async abrirModulo() {
    ...
    await this.navigateMenu(this.moduloJoyeria, this.menuParametros, this.submenuProveedores);
